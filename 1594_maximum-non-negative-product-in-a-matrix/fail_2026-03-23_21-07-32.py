...
# Status   : Failed ❌
# Date     : 2026-03-23 21:07:32
# ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─
# Input    : [[2,1,3,0,-3,3,-4,4,0,-4],[-4,-3,2,2,3,-3,1,-1,1,-2],[-2,0,-4,2,4,-3,-4,-1,3,4],[-1,0,1,0,-3,3,-2,-3,1,0],[0,-1,-2,0,-3,-4,0,3,-2,-2],[-4,-2,0,-1,0,-3,0,4,0,-3],[-3,-4,2,1,0,-4,2,-4,-1,-3],[3,-2,0,-4,1,0,1,-3,-1,-1],[3,-4,0,2,0,-2,2,-4,-2,4],[0,4,0,-3,-4,3,3,-1,-2,-2]]
# Expected : 19215865
# Got      : 1019215872
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
class Solution:
    ...
    def maxProductPath(self, grid: List[List[int]]) -> int:
        ...
        self.n = len(grid[0])
        self.grid = grid
        return max(*self.traverse(0, 0), -1)
